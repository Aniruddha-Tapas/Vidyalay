...
public final class Class2 extends Activity implements OnFullscreenListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Title2nd: "+title + "Position : " + position,Toast.LENGTH_LONG).show();
    ...
    */
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        static {
            List<VideoEntry> list2 = new ArrayList<VideoEntry>();
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Toast.makeText(getActivity(),"Title3rd: "+ title3 + "Position3rd : " + position,Toast.LENGTH_SHORT).show();
